  ...
  <div class="card" style="margin-bottom:1.5rem" id="vol-card">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;margin-bottom:1rem">
      <div style="background:var(--bg2);border-radius:var(--r);padding:.75rem">
        <div style="font-size:11px;color:var(--text3);margin-bottom:4px;display:flex;align-items:center;gap:5px">
          <span style="width:7px;height:7px;border-radius:50%;background:#639922;flex-shrink:0"></span>Billed
        </div>
        <div style="font-size:18px;font-weight:500;color:var(--text)" id="vol-gross">—</div>
        <div style="font-size:11px;color:var(--text3);margin-top:2px">invoice total</div>
      </div>
      <div style="background:var(--bg2);border-radius:var(--r);padding:.75rem">
        <div style="font-size:11px;color:var(--text3);margin-bottom:4px;display:flex;align-items:center;gap:5px">
      ...
      <div style="background:var(--bg2);border-radius:var(--r);padding:.75rem">
        <div style="font-size:11px;color:var(--text3);margin-bottom:4px;display:flex;align-items:center;gap:5px">
          <span style="width:7px;height:7px;border-radius:50%;background:#185FA5;flex-shrink:0"></span>Collected
        </div>
    ...
    <div style="display:flex;flex-direction:column;gap:7px">
      <div style="display:grid;grid-template-columns:60px 1fr 72px;gap:8px;align-items:center">
        <span style="font-size:11px;color:var(--text3);text-align:right">Billed</span>
      ...
      <div id="vol-row-refunds" style="display:grid;grid-template-columns:60px 1fr 72px;gap:8px;align-items:center">
...
function updateVolCard(){{
  ...
  const rowRefunds=document.getElementById("vol-row-refunds");
  if(rowRefunds) rowRefunds.style.display=r>0?"grid":"none";
